package com.alfredoalfonzo.testjhipster.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhipsterTest");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhipsterTest");
        ...
        config.getMapConfigs().put("com.alfredoalfonzo.testjhipster.domain.*", initializeDomainMapConfig(jHipsterProperties));
